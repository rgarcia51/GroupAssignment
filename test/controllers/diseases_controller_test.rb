...
class DiseasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disease" do
    assert_difference('Disease.count') do
      post diseases_url, params: { disease: { description: @disease.description, name: @disease.name } }
    end
  ...
  test "should update disease" do
    patch disease_url(@disease), params: { disease: { description: @disease.description, name: @disease.name } }
